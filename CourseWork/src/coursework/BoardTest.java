...
public class BoardTest {
	...
	public void testCheckPlayerEmpty() throws Exception {
		Board board = new Board("/Users/lewis/Desktop/Boards/only-starting.brd",4);
	...
	public void testCheckAdjacentSpaceForward() throws Exception {
		Board board = new Board("/Users/lewis/Desktop/Boards/only-starting-testForward.brd",4);
	...
	public void testCheckOutsideBoardForward() throws Exception {
		Board board = new Board("/Users/lewis/Desktop/Boards/only-starting-edge.brd",4);
	...
	public void testSameEntityLocation() throws Exception{
		Board boardF = new Board("/Users/lewis/Desktop/Boards/only-flags.brd",4);
		...
		Board boardG = new Board("/Users/lewis/Desktop/Boards/only-gears.brd",4);
		assertEquals(boardG.sameEntityLocation(robot1),boardG.getBoardEntity()[1][1]);
		Board boardP = new Board("/Users/lewis/Desktop/Boards/only-pits.brd",1);
	...
	public void testGetNumberOfFlags() throws Exception{
		Board board = new Board("/Users/lewis/Desktop/Boards/only-flags.brd",4);
	...
	public void testRemoveRobotFromBoard() throws Exception{
		Board board = new Board("/Users/lewis/Desktop/Boards/only-starting.brd",1);
