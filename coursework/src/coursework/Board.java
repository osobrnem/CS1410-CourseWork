...
public class Board {
	...
	public Board(String file, int NOP) throws Exception {
		...
		boardString = br.generateBoardString(boardFile);
		boardEntity = br.generateBoardEntity(boardFile);
		playerLocations = br.generateBoardPlayers(boardFile);
	...
	public Flag sameEntityLocation(int r, int c) {
		if (boardEntity[r][c] instanceof Flag) {
